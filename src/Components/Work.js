...
function Work({ position, company, location, duration }) {
  return (
    <article className="pt-5 border-b-2 border-dark-content pb-10 dark:border-light-content border-opacity-20 dark:border-opacity-20">
      ...
      <div className="flex justify-between pt-2">
        ...
        <p className="text-content text-xs md:text-sm font-medium pl-1 min-w-fit">{duration}</p>
      </div>
    </article>
  );
}
